...
@section('content')
    <div class="container-fluid">
        <div class="panel shadow">
            <div class="header">
                <h3 class="title"><i class="fa fa-users" aria-hidden="true"></i> Encargados</h3>
            </div>
            ...
            <div class="col-md-12 mtop16">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('filter', null, ['class' => 'form-control',  'placeholder' => 'Escriba nombre o email', 'required']) !!}
