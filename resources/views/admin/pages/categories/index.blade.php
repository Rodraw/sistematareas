       ...
       <div class="row">
            <div class="col-md-3">
                <div class="panel shadow">
                    <div class="header">
                        <h3 class="title"><i class="fa fa-plus" aria-hidden="true"></i> Nueva Categoria</h3>
                    </div>
                    ...
                    <label for="module" class="mtop16">En:</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                    ...
                    {!! Form::select('module', ['0' => 'Tareas'], 0, ['class' => 'custom-select']) !!}
                    </div>  
 
                    <label for="description" class="mtop16">Descripción:</label>
                    <div class="input-group">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basuc-addon1">
                                <i class="fa fa-keyboard" aria-hidden="true"></i> 
                    ...
                    {!! Form::submit('Registrar categoria', [ 'class' => 'btn btn-success mtop16']) !!} 
                    {!! Form::close() !!}
                    </div>
                    ...
                    <div class="inside">
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::text('filter', null, ['class' => 'form-control',  'placeholder' => 'Escriba una categoria', 'required']) !!}
